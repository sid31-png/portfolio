...
(function () {
  const fr = {
    ...
    rch_after:"Après — le site en ligne", rch_before:"Avant — aucune présence", rch_hint:"Glissez la poignée pour comparer l'ancien rendu au vrai site que j'ai conçu.", rch_live:"Ouvrir le site en ligne ↗",
  ...
  const ar = {
    ...
    rch_after:"بعد — الموقع المباشر", rch_before:"قبل — لا حضور", rch_hint:"اسحب المقبض لمقارنة الشكل القديم بالموقع الحقيقي الذي صمّمته.", rch_live:"افتح الموقع المباشر ↗",
