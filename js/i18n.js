...
(function () {
  const fr = {
    ...
    exp_d1:"Mai 2025 — Présent", exp_r1:"Product Designer & Développeur Front-End", exp_x1:"J'ai conçu & développé le CRM/ERP interne de RCH et le site corporate Saudi — design system, dashboards et front-end. J'ai piloté le marketing & digital ; les outils livrés ont réduit le temps de traitement de 20% sur 500+ mandats.",
    exp_d2:"Nov. 2024 — Mai 2025", exp_r2:"Marketing Digital & Solutions Client", exp_x2:"J'ai géré la marque, les campagnes digitales et l'expérience client — +70% de clientèle, 90% de rétention.",
    exp_d3:"Mars 2020 — Juil. 2022", exp_r3:"Marketing & Digital · Développement commercial", exp_x3:"Support marketing et digital sur 150+ produits — commandes répétées +35%, adoption produit +25%, satisfaction au-dessus de 90%.",
  ...
  const ar = {
    ...
    exp_d1:"مايو 2025 — الآن", exp_r1:"مصمّم منتج ومطوّر واجهات أمامية", exp_x1:"صمّمت وطوّرت نظام CRM/ERP الداخلي لـ RCH والموقع المؤسسي السعودي — نظام تصميم ولوحات تحكم وواجهة أمامية. قُدْت التسويق والرقمي؛ والأدوات التي أطلقتها خفضت زمن المعالجة 20% عبر +500 معاملة.",
    exp_d2:"نوفمبر 2024 — مايو 2025", exp_r2:"تسويق رقمي وحلول العملاء", exp_x2:"أدرت العلامة والحملات الرقمية وتجربة العميل — نمو العملاء 70% واحتفاظ 90%.",
    exp_d3:"مارس 2020 — يوليو 2022", exp_r3:"تسويق ورقمي · تطوير أعمال", exp_x3:"دعم تسويقي ورقمي عبر +150 منتجاً — طلبات متكررة +35%، تبنٍّ +25%، رضا فوق 90%.",
