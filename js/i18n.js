...
(function () {
  const fr = {
    ...
    ba_before:"Avant", ba_after:"Après", ba_cap1:"Le site rch.qa existant", ba_cap2:"Ma refonte — en ligne", ba_meta:"Conçu en React & Tailwind · bilingue EN / AR",
  ...
  const ar = {
    ...
    ba_before:"قبل", ba_after:"بعد", ba_cap1:"موقع rch.qa الحالي", ba_cap2:"إعادة تصميمي — مباشر", ba_meta:"بُني بـ React وTailwind · ثنائي اللغة EN / AR",
