...
(function () {
  const fr = {
    ...
    work_c4_t:"L'idée était la mienne", work_c4_x:"J'ai conçu, designé et livré le site RCH Saudi de bout en bout — positionnement, système visuel et build.", work_c4_l:"Dans le projet →",
  ...
  const ar = {
    ...
    work_c4_t:"الفكرة كانت فكرتي", work_c4_x:"تصوّرت وصمّمت وأطلقت موقع RCH السعودية بالكامل — التموضع والنظام البصري والبناء.", work_c4_l:"داخل المشروع →",
