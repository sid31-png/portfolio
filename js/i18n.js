...
(function () {
  const fr = {
    ...
    work_c4_t:"Automatisation des process gouvernementaux", work_c4_x:"500+ mandats gérés ; refonte du process et automatisations no-code réduisant le temps de traitement de 20%.", work_c4_l:"RCH · en cours",
    work_c5_t:"Montage & génération vidéo", work_c5_x:"Montages courts et vidéo générée par IA pour la marque et le social — du motion qui vend.", work_c5_l:"Showreel — bientôt",
  ...
  const ar = {
    ...
    work_c4_t:"أتمتة العمليات الحكومية", work_c4_x:"إدارة +500 معاملة؛ إعادة تصميم العملية وأتمتة بدون كود خفضت زمن المعالجة 20%.", work_c4_l:"RCH · جارية",
    work_c5_t:"مونتاج وتوليد الفيديو", work_c5_x:"مونتاجات قصيرة وفيديو مولّد بالذكاء الاصطناعي للعلامة والسوشيال — موشن يبيع.", work_c5_l:"العرض — قريباً",
