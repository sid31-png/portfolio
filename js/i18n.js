...
(function () {
  const fr = {
    ...
    rch_after:"Après — ma refonte", rch_before:"Avant — aucune présence", rch_hint:"Glissez la poignée pour comparer · visuels d'exemple — à remplacer par de vraies captures",
  ...
  const ar = {
    ...
    rch_after:"بعد — إعادة تصميمي", rch_before:"قبل — لا حضور", rch_hint:"اسحب المقبض للمقارنة · صور توضيحية — استبدلها بلقطات حقيقية",
